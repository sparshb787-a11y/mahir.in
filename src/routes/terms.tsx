...
export const Route = createFileRoute("/terms")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Terms and Conditions for MAHIR Group Investment Advisers Private Limited." },
      ...
      { name: "twitter:description", content: "Terms and Conditions for MAHIR Group Investment Advisers Private Limited." },

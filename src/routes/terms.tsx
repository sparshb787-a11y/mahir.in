      ...
      <main className="pt-24 pb-16 md:pt-32 md:pb-24 px-6 max-w-4xl mx-auto w-full">
        ...
        <div className="prose prose-lg max-w-none text-[#000000]">
          ...
          <p className="mb-4">
            ...
            these Terms in their entirety. If you do not agree with any part of these Terms, please
            immediately discontinue use of the Platform and Services.
          </p>
          <p className="mb-4">
            These Terms shall be read in conjunction with the Privacy Policy, Disclaimers, SEBI
            Disclosures, and the Investor Charter, all of which are incorporated herein by reference
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              <strong>"Platform"</strong> collectively means the MIA mobile application and website
              (www.mahir.in) and all associated digital interfaces.
            </li>
            <li>
              <strong>"Client Agreement"</strong> means the separate formal agreement executed
              between MIA and each Client as mandated under SEBI IA Regulations, 2013.
            </li>
            <li>
              <strong>"KYC"</strong> means Know Your Customer documentation and verification as
              required under applicable SEBI, PMLA, and RBI guidelines.
            </li>
            <li>
              <strong>"AUA"</strong> means Assets Under Advice the aggregate value of the client's
              investment portfolio for which MIA provides advisory services.
            </li>
            <li>
              <strong>"Investment Advice"</strong> means advice relating to investing in,
              purchasing, selling, or otherwise dealing in securities or investment products, or
              advice on investment portfolio, as defined under SEBI IA Regulations.
            </li>
            <li>
              <strong>"Principal Officer"</strong> means Yash Mahavir Bedmuttha, the key management
              person designated and registered with SEBI for MIA.
            </li>
            <li>
              <strong>"Applicable Laws"</strong> means the SEBI Act, 1992; SEBI (IA) Regulations,
              2013; SEBI Circulars; Prevention of Money Laundering Act, 2002; Information Technology
              Act, 2000; Digital Personal Data Protection Act, 2023; and all other applicable laws,
              rules, and regulations of India in force from time to time.
            </li>
            <li>
              <strong>"SEBI"</strong> means the Securities and Exchange Board of India constituted
              under the SEBI Act, 1992.
            </li>
            <li>
              <strong>"PMLA"</strong> means the Prevention of Money Laundering Act, 2002 and the
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              Not be a Politically Exposed Person (PEP) or a close associate of a PEP unless MIA
              expressly agrees to onboard you after conducting Enhanced Due Diligence.
            </li>
          </ul>
          <p className="mb-4 text-sm italic">
            Disclaimer: MIA reserves the right to decline or terminate services to any person at its
            sole discretion and without assigning reasons, subject to applicable regulatory
            guidelines.
          </p>
          ...
          <p className="mb-4">
            ...
            objectives, investment horizon, and other relevant parameters disclosed by you. MIA does
            not exercise discretionary management over client portfolios; all final investment
            decisions rest with the client.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              Asset allocation guidance across equity, debt, mutual funds, ETFs, and other
              SEBI-regulated securities.
            </li>
            <li>Research-based investment recommendations with written rationale.</li>
            <li>
              Comprehensive financial planning including retirement planning, wealth creation, and
              goal-based planning.
            </li>
          ...
          <p className="mb-4">
            MIA does NOT offer the following services, and nothing on the Platform shall be
            construed as:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
          ...
          <h3 className="text-2xl font-semibold mt-10 mb-4">
            5. CLIENT ONBOARDING AND KYC REQUIREMENTS
          </h3>
          <p className="mb-4">
            In strict accordance with SEBI (IA) Regulations, 2013 and PMLA, 2002, the following
            onboarding procedure applies:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              <strong>Full KYC Mandate:</strong> All clients must complete full KYC verification
              before receiving any investment advisory services from MIA.
            </li>
            <li>
              <strong>Required Documents:</strong> PAN card, Aadhaar card (for address/identity
              proof), recent passport-size photograph, active bank account details (cancelled
              cheque), income proof (latest ITR, Form 16, or salary slip), and net worth certificate
              where applicable.
            </li>
            <li>
              <strong>Risk Assessment:</strong> MIA shall conduct a comprehensive Risk Profiling of
              each client covering risk tolerance, investment horizon, financial goals, and existing
              investments prior to providing investment advice.
            </li>
            <li>
              <strong>Client Agreement:</strong> Each client shall execute a formal Client Agreement
              as mandated by SEBI before commencement of any advisory services. The Client Agreement
              shall specify fee structure, scope of services, and rights and obligations of both
              parties.
            </li>
            <li>
              <strong>Updates:</strong> Any material change in the client's financial situation,
              employment, risk appetite, or investment objectives must be promptly communicated to
              MIA in writing or via the Platform.
            </li>
            <li>
              <strong>Compliance Cycles:</strong> MIA shall conduct periodic re-KYC, risk profile
              reassessment, and portfolio reviews in accordance with SEBI guidelines and the Client
              Agreement.
            </li>
          </ul>
          <p className="mb-4 text-sm italic">
            Note: Clients who fail to complete KYC or provide requisite documents shall not be
            eligible to receive advisory services until compliance is achieved.
          </p>
          ...
          <p className="mb-4">
            ...
            Regulations, 2013. Advisory fees shall not exceed the limits prescribed by SEBI from
            time to time:
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              All payments must be made by NEFT/RTGS/UPI/online transfer directly to MIA's
              registered and disclosed bank account. Cash payments are strictly not accepted.
            </li>
            <li>
            ...
            <li>
              MIA does not accept any commission, trail fee, referral fee, or any other remuneration
              from product manufacturers, fund houses, or any third party in connection with advice
              given to clients.
            </li>
          </ul>
          ...
          <p className="mb-4">
            Advisory fees once paid are non-refundable, except in the following circumstances: (a)
            service failure directly and solely attributable to MIA and established after due
            inquiry; (b) as required under applicable law or SEBI directives. All fee disputes must
            be raised with the Compliance Officer within 30 calendar days of the relevant invoice
            date.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              You shall not attempt to reverse engineer, decompile, disassemble, or compromise any
              software or security component of the Platform.
            </li>
            <li>
            ...
            <li>
              You shall maintain the confidentiality of all investment advice, research, and
              communications received from MIA and shall not share, publish, or distribute such
              content without MIA's prior written consent.
            </li>
            <li>
              You acknowledge that investment in securities markets involves market risk and you are
              capable of bearing such risk based on your disclosed financial profile.
            </li>
          </ul>
          ...
          <p className="mb-4">
            ...
            images, software code, research reports, financial models, algorithms, and educational
            contentis the exclusive intellectual property of MIA or its licensors and is protected
            under the Copyright Act, 1957, the Trade Marks Act, 1999, and other applicable Indian
            intellectual property laws.
          </p>
          <p className="mb-4">
            You are granted a limited, non-exclusive, non-transferable, revocable license to access
            and use the Platform solely for your personal investment advisory and financial planning
            purposes. You shall not reproduce, modify, distribute, publicly display, sublicense, or
            create derivative works from any content without the prior written consent of MIA.
          </p>

          <h3 className="text-2xl font-semibold mt-10 mb-4">9. DISCLAIMER OF LIABILITY</h3>
          <p className="mb-4">
            To the fullest extent permitted by applicable law, MIA, its directors, officers,
            employees, and agents shall not be liable for:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              Any investment losses arising from advice provided in good faith based on information
              furnished by the client.
            </li>
            <li>
              Market risks, systemic risks, geopolitical risks, regulatory changes, or force majeure
              events.
            </li>
            <li>
              Decisions made by the client contrary to, or independent of, advice given by MIA.
            </li>
            <li>
              Interruption, unavailability, errors, or data loss arising from Platform downtime or
              technical failures.
            </li>
            <li>
              Third-party services, websites, financial products, or platforms accessible through or
              linked from our Platform.
            </li>
            <li>Tax consequences of investment decisions.</li>
          </ul>
          <p className="mb-4 font-semibold">
            Limitation: MIA's total aggregate liability under or in connection with these Terms, if
            any, shall not exceed the advisory fees actually paid by you to MIA in the six months
            ...
            <tbody>
              <tr className="border-b">
                ...
                <td className="py-2 px-4">
                  compliance@mahir.in | +91 9084945151
                  <br />
                  TAT: 30 days
                </td>
              </tr>
          ...
          <p className="mb-4">
            MIA is committed to full compliance with PMLA, 2002 and SEBI's AML/CFT guidelines. MIA
            maintains robust Customer Due Diligence (CDD) and Enhanced Due Diligence (EDD)
            procedures for high-risk clients and transactions.
          </p>
          <p className="mb-4">
            <strong>Regulatory Mandate:</strong> MIA may report suspicious transactions to the
            Financial Intelligence Unit India (FIU-IND) and may be required by law to share client
            information with regulatory or law enforcement authorities without prior notice.
          </p>
          ...
          <p className="mb-4">
            ...
            provisions contained in the individual Client Agreement. Disputes may be referred to
            arbitration under the Arbitration and Conciliation Act, 1996 as specified in the Client
            Agreement.
          </p>
          ...
          <p className="mb-4">
            ...
            of the amended Terms. If you do not agree with amended Terms, you must terminate your
            engagement with MIA by providing 30 days written notice to compliance@mahir.in.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              ...
              void, or unenforceable by a competent court, such provision shall be deemed severed
              and the remaining provisions shall continue in full force and effect.
            </li>
            <li>
              <strong>Entire Agreement:</strong> These Terms, together with the Privacy Policy,
              Disclaimers, Client Agreement, and SEBI Disclosures, constitute the entire agreement
              between you and MIA, superseding all prior agreements, representations, and
              understandings.
            </li>
            <li>
              <strong>Waiver:</strong> Failure by MIA to enforce any provision of these Terms on one
              occasion shall not constitute a waiver of that provision or any right on any
              subsequent occasion.
            </li>
            <li>
              <strong>Assignment:</strong> You may not assign, transfer, or sub-license your rights
              or obligations under these Terms without MIA's prior written consent. MIA may assign
              its rights to a successor entity following regulatory approvals.
            </li>
            <li>
              <strong>Force Majeure:</strong> MIA shall not be liable for failure or delay in
              performance due to circumstances beyond its reasonable control including acts of God,
              pandemic, war, regulatory action, or internet failure.
            </li>
          </ul>
        </div>
      </main>

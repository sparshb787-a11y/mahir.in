      ...
      <main className="pt-24 pb-16 md:pt-32 md:pb-24 px-6 max-w-4xl mx-auto w-full">
        ...
        <div className="prose prose-lg max-w-none text-[#000000]">
            ...
            <tbody>
              ...
              <tr className="border-b">
                ...
                <td className="py-2 px-4">
                  Full refund (100%) less applicable payment gateway charges
                </td>
                <td className="py-2 px-4">Within 15 business days</td>
              </tr>
              <tr className="border-b">
              ...
              <tr>
                <td className="py-2 px-4">
                  Cancellation due to Client's regulatory non-compliance
                </td>
                <td className="py-2 px-4">No refund applicable</td>
                <td className="py-2 px-4">N/A</td>
              </tr>
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-8">
            ...
            <p>
              <strong>Grievance Escalation:</strong> If your refund or cancellation grievance is not
              resolved within 30 days, you may escalate it to SEBI SCORES (scores.gov.in) or
              approach the competent courts at Pune, Maharashtra, India.
            </p>
          </div>
        </div>
      </main>

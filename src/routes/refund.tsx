...
export const Route = createFileRoute("/refund")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Refund Policy for MAHIR Group Investment Advisers Private Limited." },
      ...
      { name: "twitter:description", content: "Refund Policy for MAHIR Group Investment Advisers Private Limited." },

...
export const Route = createFileRoute("/privacy")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Privacy Policy for MAHIR Group Investment Advisers Private Limited." },
      ...
      { name: "twitter:description", content: "Privacy Policy for MAHIR Group Investment Advisers Private Limited." },

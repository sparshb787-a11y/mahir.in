      ...
      <main className="pt-24 pb-16 md:pt-32 md:pb-24 px-6 max-w-4xl mx-auto w-full">
        ...
        <div className="prose prose-lg max-w-none text-[#000000]">
          <div className="bg-gray-50 p-6 rounded-lg mb-8 text-sm">
            ...
            <p>
              <strong>Data Fiduciary:</strong> MAHIR Investment Advisers Private Limited
            </p>
            <p>
            ...
            <p>
              <strong>Data Protection Officer (DPO):</strong> Bharat Makkar
            </p>
            <p>
              <strong>Email:</strong> compliance@mahir.in
            </p>
            <p>
              <strong>Phone No:</strong> +91 9084945151
            </p>
            <p>
              <strong>Grievance Officer:</strong> Bharat Makkar | compliance@mahir.in
            </p>
          </div>
          ...
          <p className="mb-4">
            ...
            applicable law. This Policy forms part of the overall agreement between you and MIA and
            should be read alongside the Terms and Conditions and Client Agreement.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              <strong>Identity Data:</strong> Full legal name, PAN card number, Aadhaar number
              (masked/tokenized as permitted), date of birth, photograph, and specimen signature.
            </li>
            <li>
              <strong>Contact Data:</strong> Residential and correspondence address, email address,
              mobile number, and emergency contact details.
            </li>
            <li>
              <strong>Financial Data:</strong> Gross annual income, net worth, bank account details
              (for fee payments), investment portfolio information, existing liabilities, tax
              status, and FATCA/CRS declarations.
            </li>
            <li>
              <strong>KYC & AML Data:</strong> Documentary evidence for KYC compliance, source of
              funds and wealth, politically exposed person (PEP) status, and sanctions screening
              data.
            </li>
            <li>
              <strong>Risk Profile Data:</strong> Risk tolerance questionnaire responses, investment
              objectives, investment horizon, prior investment experience, and financial goals.
            </li>
            <li>
              <strong>Platform Usage Data:</strong> IP address, device identifiers, browser type and
              version, operating system, pages visited, session duration, click-stream data, and
              referral URLs.
            </li>
            <li>
              <strong>Communication Data:</strong> Queries, complaints, call recordings (with
              consent), correspondence, and meeting notes.
            </li>
            <li>
              <strong>Technical Data:</strong> App crash reports, error logs, and performance
              diagnostic metrics.
            </li>
          </ul>
          ...
          <p className="mb-4">
            The following categories constitute SPDI under the IT SPDI Rules, 2011 and are collected
            only with your explicit prior consent:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              <strong>Financial information:</strong> Bank account numbers, credit card/debit card
              details (solely for fee payment), income details, and net worth information.
            </li>
            <li>
              <strong>Biometric data:</strong> Where applicable and legally permitted (e.g., for
              eKYC purposes).
            </li>
            <li>
              <strong>Aadhaar details:</strong> As permitted under the Aadhaar (Targeted Delivery)
              Act, 2016 and applicable guidelines.
            </li>
          </ul>

          <h4 className="text-xl font-semibold mt-6 mb-2">2.3 Data We Do Not Collect</h4>
          <p className="mb-4">
            MIA does not collect racial or ethnic origin, political opinions, religious or
            philosophical beliefs, trade union membership, health data (unless specifically relevant
            for insurance advisory, which MIA does not presently offer), genetic data, or sexual
            orientation data.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              <strong>Regulatory Authorities:</strong> SEBI, AMFI, Stock Exchanges, Depositories
              (NSDL/CDSL), Registrar and Transfer Agents, and other financial market regulators as
              required by law.
            </li>
            <li>
              <strong>Financial Intelligence Unit — India (FIU-IND):</strong> for AML/CFT reporting
              obligations under PMLA.
            </li>
            <li>
              <strong>KYC Registration Agencies (KRAs) and Central KYC Registry (CKYCRR):</strong>{" "}
              for KYC verification and record maintenance.
            </li>
            <li>
              <strong>Technology Service Providers:</strong> Cloud hosting partners, IT vendors, and
            ...
            <li>
              <strong>Professional Advisers:</strong> Statutory auditors, legal counsel, and tax
              advisers, subject to appropriate confidentiality obligations.
            </li>
            <li>
              <strong>Legal Mandates:</strong> Courts, Tribunals, or Law Enforcement Authorities
              pursuant to a valid court order, summons, or statutory requirement.
            </li>
          </ul>
          <p className="mb-4">
            All third-party data processors are contractually bound to maintain security standards
            not lower than those maintained by MIA. Cross-border data transfers, if any, shall
            comply with provisions of the DPDP Act, 2023, including adequate safeguards.
          </p>
          ...
          <p className="mb-4">
            ...
            or irreversibly anonymized in accordance with applicable law. Records subject to ongoing
            legal/regulatory proceedings shall be retained until resolution.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            ...
            <li>
              <strong>Access Controls:</strong> Role-based access controls (RBAC) ensuring data
              access is strictly limited to authorized personnel on a need-to-know basis.
            </li>
            <li>
              <strong>Authentication:</strong> Multi-factor authentication (MFA) mandatory for all
              personnel accessing client data and for Platform login.
            </li>
            <li>
              <strong>Security Audits:</strong> Regular security audits, vulnerability assessments,
              and penetration testing by qualified third-party security professionals.
            </li>
            <li>
              <strong>Incident Response:</strong> Documented incident response procedures for data
              breach detection, containment, and notification.
            </li>
            <li>
              <strong>Data Breach Notification:</strong> In the event of a personal data breach, MIA
          ...
          <p className="mb-4">
            The MIA Platform uses cookies and similar tracking technologies (web beacons, pixels,
            local storage) to provide a seamless user experience. Categories:
          </p>
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              <strong>Strictly Necessary Cookies:</strong> Essential for core Platform functionality
              including login sessions, security tokens, and fraud prevention. These cannot be
              disabled without impacting Platform functionality.
            </li>
            <li>
              <strong>Analytics Cookies:</strong> Used to understand Platform usage patterns, page
              performance, and user behaviour collected only with your explicit consent.
            </li>
            <li>
              <strong>Preference Cookies:</strong> Used to remember your Platform settings and
              preferences collected with consent.
            </li>
            <li>
              <strong>Marketing Cookies:</strong> Used to deliver relevant financial content and
              updates collected only with opt-in consent.
            </li>
          </ul>
          <p className="mb-4">
            You may manage cookie preferences at any time through your browser settings or the
            Platform's cookie consent manager. Disabling non-essential cookies will not affect your
            ability to receive core advisory services.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2 mb-6">
            <li>
              <strong>Right to Access:</strong> Obtain summary of personal data processed and
              processing activities undertaken (Written request to DPO).
            </li>
            <li>
              <strong>Right to Correction:</strong> Request correction, completion, or updating of
              inaccurate/incomplete personal data (Written request to DPO).
            </li>
            <li>
              <strong>Right to Erasure:</strong> Request deletion of personal data, subject to legal
              retention obligations and regulatory requirements (Written request to DPO).
            </li>
            <li>
              <strong>Right to Grievance Redressal:</strong> Raise grievances about personal data
              processing with the Data Protection Officer (Email to compliance@mahir.in).
            </li>
            <li>
              <strong>Right to Nominate:</strong> Nominate an individual to exercise data rights on
              your behalf in case of death or incapacity (Written request to DPO).
            </li>
            <li>
              <strong>Right to Withdraw Consent:</strong> Withdraw consent for processing not based
          ...
          <p className="mb-4">
            ...
            identity verification before processing requests. Some rights may be subject to
            exceptions where processing is required by law.
          </p>

          <h3 className="text-2xl font-semibold mt-10 mb-4">9. CHILDREN'S PRIVACY</h3>
          <p className="mb-4">
            The MIA Platform and Services are intended exclusively for persons 18 years of age and
            above. MIA does not knowingly collect, process, or store personal data from minors under
            18 years of age. If MIA becomes aware that personal data of a minor has been
            inadvertently collected, it shall promptly delete such data in accordance with the DPDP
            Act, 2023 and notify the parent or guardian.
          </p>

          <h3 className="text-2xl font-semibold mt-10 mb-4">10. UPDATES TO THIS PRIVACY POLICY</h3>
          <p className="mb-4">
            MIA may update this Privacy Policy periodically to reflect changes in legal or
            regulatory requirements, business practices, data processing activities, or
            technological changes. Material updates will be communicated via the Platform's
            notification system and/or by email to registered clients at least 15 days prior to the
            update taking effect. The date of the latest revision is prominently displayed at the
            top of this Policy. Continued use of the Platform after notification of changes
          ...
          <div className="bg-gray-50 p-6 rounded-lg mb-8">
            <p>
              <strong>Data Protection Officer:</strong> Bharat Makkar
            </p>
            <p>
              <strong>Email:</strong> compliance@mahir.in
            </p>
            ...
            <p className="mt-4">
              <strong>Registered Address:</strong> PL G/A-9/1 Shop 1, MIDC G Nr Moris So, Chinchwad
              East, Pune 411019, Maharashtra
            </p>
            <p>
            ...
            <p>
              <strong>Jurisdiction:</strong> Courts at Pune, Maharashtra, India. If your complaint
              or concern is not satisfactorily resolved by MIA's DPO, you may approach the Data
              Protection Board of India (once constituted and operational under the DPDP Act, 2023)
              or SEBI SCORES (scores.gov.in) for SEBI-related grievances.
            </p>
          </div>
        </div>
      </main>

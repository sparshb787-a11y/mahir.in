...
export const Route = createFileRoute("/cancellation")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Cancellation Policy for MAHIR Group Investment Advisers Private Limited." },
      ...
      { name: "twitter:description", content: "Cancellation Policy for MAHIR Group Investment Advisers Private Limited." },

...
export const Route = createFileRoute("/disclaimer")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Regulatory and Investment Disclaimer for MAHIR Group Investment Advisers Private Limited." },
      ...
      { name: "twitter:description", content: "Regulatory and Investment Disclaimer for MAHIR Group Investment Advisers Private Limited." },

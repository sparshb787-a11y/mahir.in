...
const people: Person[] = [
  ...
  { name: "Ashwin Patil", role: "Investment Analyst - Mutual Fund", photo: ashwinImage, thoughtProcess: "Filtering thousands of funds to find the few that consistently beat the market. Asset allocation is the ultimate alpha." },
  ...
  { name: "Deepak Porwal", role: "Senior Software Developer", photo: deepakImage, thoughtProcess: "Writing clean, performant code that powers mission-critical financial applications. Every millisecond counts." },
  ...
  { name: "Janvi Aswani", role: "Human Resources", photo: "/janvi.jpg", thoughtProcess: "Building a workplace where people thrive. Passionate about creating processes that put people first." },
  ...
  { name: "Mangesh Gore", role: "Software Developer Intern", photo: mangeshImage, thoughtProcess: "Eager to learn, quick to adapt, and ready to write code that matters. Building the future of fintech." },
  { name: "Chandrakant Mali", role: "Software Developer Intern", photo: chandrakantImage, thoughtProcess: "Translating academic knowledge into real-world software solutions. Every bug fixed is a lesson learned." },
  { name: "Awishkar Kumbhar", role: "Software Developer Intern", photo: awishkarImage, thoughtProcess: "Passionate about modern web technologies and optimizing performance. Excited to contribute to a scalable architecture." },
  { name: "Shubham Gavhane", role: "Software Developer Intern", photo: shubhamImage, thoughtProcess: "Focusing on clean code and reliable testing. Building a strong foundation for a career in software engineering." },
  { name: "Gunjan Vishwakarma", role: "Software Developer Intern", photo: gunjanImage, thoughtProcess: "Bringing fresh perspectives to complex algorithmic challenges. Determined to build software that creates real impact." },
];
